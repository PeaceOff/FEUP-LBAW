...
<div class="container-fluid padding-0 content-relative">
...
<!-- LINKS -->
    <div class="container">
      ...
      <div class="carousel slide" id="linkCarrousel">
        <div class="carousel-inner">
          <div class="item active"><!-- /Slide1 -->
            <ul class="thumbnails">
              <li class="card col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <nav>
          <ul class="control-box pager">
            <li><a data-slide="prev" href="#linkCarrousel" class=""><i class="glyphicon glyphicon-chevron-left"></i></a></li>
            <li><a data-slide="next" href="#linkCarrousel" class=""><i class="glyphicon glyphicon-chevron-right"></i></a></li>
            </ul>
          </nav>
          <!-- /.control-box -->
