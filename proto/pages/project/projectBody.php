...
<div class="col-md-12">
  ...
  <div class="container">
    ...
    <?php include_once 'listLinks.php' ?>
  ...
  <div class="container">
    ...
    <div class="carousel slide" id="documentsCarrousel">
      <div class="carousel-inner">
        <div class="item active"><!-- /Slide1 -->
          <?php include_once 'listDocuments.php' ?>
                    </div>
                    <div class="item"><!-- /Slide2 -->
                      <ul class="thumbnails">
                        <li>
                          <a class="cardLink" href="projectPage.php">
                            <?php include 'document-card.php';?>
                          </a>
                          <li>
                            <li>
                              <a class="cardLink" href="projectPage.php">
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <a  href="../todo/todoPage.php#to-do" > <img src="../../images/todo.png" class="img-responsive img-circle center-block" width="200"> </a>
      </div>
